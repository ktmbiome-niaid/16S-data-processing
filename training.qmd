...
The important thing to note about the code is that we're looking for this primer sequence at the very beginning of the sequence read. We might see this sequence in other parts of the read, but that doesn't necessarily indicate the presence of primers.
...
We don't see any primer sequences at the start of our reads, so we can move forward!
...
[![Schematic of the DADA Algorithm](dada_schematic.webp){fig-align="center"}](https://bmcbioinformatics.biomedcentral.com/articles/10.1186/1471-2105-13-283)
...
![Read Merging Schematic](ReadMerging.png){fig-align="center"}
